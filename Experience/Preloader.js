    ...
    secondIntro() {
        return new Promise((resolve) => {
            ...
            this.secondTimeline
                ...
                // .to(
                //     this.roomChildren.stand_top.scale,
                //     {
                //         x: 1,
                //         y: 1,
                //         z: 1,
                ...
                .to(
                    ...
                    ">-0.2",
                    // this.roomChildren.bed.name = "bed_done",
                )
                .to(
                ...
                // .to(
                //     this.roomChildren.desk_right.scale,
                //     {
                //         x: 1,
                //         y: 1,
                //         z: 1,
                ...
                // .to(
                //     this.roomChildren.coffee_book.scale,
                //     {
                //         x: 1,
                //         y: 1,
                //         z: 1,
                ...
                .to(
                    this.roomChildren.minute.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
                ...
                //     duration: 0.5,
                // })
                .to(this.roomChildren.comps.scale, {
                    x: 1,
                    y: 1,
                    z: 1,
                    ease: "back.out(2.2)",
                ...
                .to(this.roomChildren.screen2.scale, {
                    x: 1,
                    y: 1,
                    z: 1,
                    ease: "back.out(2.2)",
                ...
                .set(this.roomChildren.outside.scale, {
                    x: 1,
                    y: 1,
                    z: 1,
                })
                ...
                .to(
                    this.roomChildren.roomba.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
